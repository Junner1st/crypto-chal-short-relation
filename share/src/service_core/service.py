...
from .params import ACCOUNT_ID, ACCOUNT_NAME, B_CURVE, FLAG, ITEM_LIMIT, P_FIELD, WINDOW
...
class Service:
    def __init__(self):
        ...
        self.aux = self.F.auxiliary_value()
        self.curve = Curve(self.F, B_CURVE, self.aux)
